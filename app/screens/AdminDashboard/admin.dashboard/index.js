...
import {Image, Text, View, ScrollView, Alert, FlatList, Modal, Linking, ImageBackground } from 'react-native';
...
export default class AdminDashboard extends Component<Props> {
  ...
  getData(){
    ...
    if (responseJson.message == 800){
        ...
        console.log('getAllProfile - Response', JSON.stringify(responseJson.data) )
  ...
  renderRow(data){
    ...
    return(//1a1e27
      ...
      shadowRadius: 3, shadowOffset: {height: 1, width: 0 }}}>
          <View 
          style = {{paddingTop:10, paddingBottom:10, paddingLeft:16, flexDirection:'row'}}>
            <ImageBackground style = {{height:110, width:110, backgroundColor:'grey', borderRadius:20}}
            source = {require('../../../assets/common/placeholder.jpg')}
            >
            <Image
          style={{width: 110, height: 110, borderRadius:20, alignSelf:'center', justifyContent:'center', }}
          source={{uri: 'http://www.alaziziyamanpower.com/uploads/images/'+data.image2}}/>
              ...
              <View style = {{marginTop:16, }}>
                ...
                <Text style = {{color:'#611e32', fontSize:14, marginLeft:16}}>{data.job_type}</Text>
                <View style = {{flexDirection:'row', justifyContent:'space-between', alignItems:'center', flex:1,}}>
                    ...
                    <FontAwesome5.Button
                      ...
                      onPress={()=>{
                        Linking.openURL(`whatsapp://send?text=&phone=${data.whatsapp}`)
                      }}
                      underlayColor='transparent'
                      backgroundColor='transparent'
                    />
