...
export default class Registration extends Component<Props> {
  ...
  componentDidMount() {
    UserDefaults.get("UserObj").then(userObj => {
      this.setState({
        id: userObj["id"]
      });
    });
      ...
      <View style={{ flex: 1, backgroundColor: "#1a1e27" }}>
        <View style={{ paddingTop: 32, paddingLeft: 30 }}>
          <Text style={styles.welcome}>
            {isUpdate == 0 ? "Signup" : "Update"}
          </Text>
          <Text style={styles.subText}>
            {isUpdate == 0 ? "New Account" : "Update your profile"}
          </Text>
        </View>
        ...
        <View style={{ flexDirection: "row", height: 40 }}>
          <TextInput
            ...
            style={[
              ...
              { marginLeft: 32, flex: 1, color: "white" }
            ]}
          ...
          <MaterialIcons.Button
            name={
              this.state.isPasswordNotVisible ? "visibility-off" : "visibility"
            }
        ...
        {isUpdate == 0 ? (
          <Text style={styles.termsText}>
            By clicking you agreed to the{" "}
            <Text style={{ color: "#8D1B3D", fontSize: 12, fontWeight: "400" }}>
