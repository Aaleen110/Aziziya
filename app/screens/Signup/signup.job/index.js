...
export default class SignupScreenJob extends Component<Props> {
  ...
  gotoNextScreen(){
    ...
    if (
      ...
      let params = 'name='+this.state.fullname
  ...
  render(){
    ...
    >
        ...
        <View style = {{flex:1, flexDirection:'row', justifyContent:'space-evenly', marginTop:20, marginBottom:16,marginLeft:-30}}>
            ...
            <View   
              style = {{borderColor:'#fff', borderWidth:0.3, marginLeft:10, backgroundColor:'#8D1B3D', height:15, width:15, alignSelf:'center', borderRadius:20, justifyContent:'center'}}>
            </View>
        ...
        <Dropdown
           ...
           onChangeText = {(value) => {this.setState({job_category:value})}}
        ...
        <Dropdown
           ...
           onChangeText = {(value) => {this.setState({job_location:value})}}
      ...
      <Text style = {{fontSize:14, color:'white', marginLeft:32, marginTop:16}}>Experience</Text>

        <View style = {{flexDirection:'row'}}>
            <Ripple 
                onPress = {()=>{this.setState({isExperienceSelected:1})}}
                style = {{height:40, width:40, backgroundColor: this.state.isExperienceSelected == 1 ? "#8D1B3D" : 'transparent', borderRadius:10, borderWidth:1.3, borderColor:'#8D1B3D', marginLeft:32, marginTop:16,justifyContent:'center'}}>
                <Text style = {{fontWeight:'bold', color:'white', alignSelf:'center', justifyContent:'center'}}>{"<1"}</Text>
            </Ripple>

            <Ripple 
                onPress = {()=>{this.setState({isExperienceSelected:2})}}
                style = {{height:40, width:40, backgroundColor:this.state.isExperienceSelected == 2 ? "#8D1B3D" : 'transparent', borderRadius:10, borderWidth:1.3, borderColor:'#8D1B3D', marginLeft:32, marginTop:16,justifyContent:'center'}}>
                <Text style = {{fontWeight:'bold', color:'white', alignSelf:'center', justifyContent:'center'}}>{"1+"}</Text>
            </Ripple>

            <Ripple 
                onPress = {()=>{this.setState({isExperienceSelected:3})}}
                style = {{height:40, width:40, backgroundColor:this.state.isExperienceSelected == 3 ? "#8D1B3D" : 'transparent', borderRadius:10, borderWidth:1.3, borderColor:'#8D1B3D', marginLeft:32, marginTop:16,justifyContent:'center'}}>
                <Text style = {{fontWeight:'bold', color:'white', alignSelf:'center', justifyContent:'center'}}>{"2+"}</Text>
            </Ripple>

            <Ripple
                onPress = {()=>{this.setState({isExperienceSelected:4})}} 
                style = {{height:40, width:40, backgroundColor:this.state.isExperienceSelected == 4 ? "#8D1B3D" : 'transparent', borderRadius:10, borderWidth:1.3, borderColor:'#8D1B3D', marginLeft:32, marginTop:16,justifyContent:'center'}}>
                <Text style = {{fontWeight:'bold', color:'white', alignSelf:'center', justifyContent:'center'}}>{"3+"}</Text>
            </Ripple>
        </View>    
         {/* HERE
          <TextInput 
    ...
    <Text style = {{fontSize:16, color:'white', marginLeft:32, marginTop:16}}>Salary per annum</Text>
        ...
        value = {this.state.current_salary}
            style = {{height:40, marginLeft:32, marginTop:0, width:Global.screenWidth/4, color:'white'}}
            />
                
            {/* <Separator style={{ height: 1, width: Global.screenWidth/2, alignSelf: 'center' }} /> */}
      ...
      <TextInput 
       ...
       <Text style = {{fontSize:14, color:'white', marginLeft:32, marginTop:16}}>Job Description</Text>
       <View style = {{borderWidth:0.3, borderColor:'white', marginLeft:32, marginRight:32, marginTop:16, height:100}}>
       ...
       value = {this.state.description}
        style = {{height:100, marginLeft:16, marginRight:36, width:Global.screenWidth-80, color:'white'}}
        />
        ...
        <Ripple 
          ...
          style = {{backgroundColor:'#8D1B3D', height:40, width:150, alignSelf:'center', borderRadius:20, justifyContent:'center', marginBottom:16}}>
