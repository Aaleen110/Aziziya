...
export default class SignupScreenUpload extends Component<Props> {
  ...
  uploadImageToServer = () => {
    ...
    RNFetchBlob.fetch('POST', 'http://alaziziyamanpower.com/new_webservices/model/upload_image.php', {
      Authorization: "Bearer access-token",
      otherHeader: "foo",
      'Content-Type': 'multipart/form-data',
    }, [
        { name: 'img_half', filename: 'image.png', type: 'image/png', data: this.state.img_half },
        
        { name: 'image', filename: 'image.png', type: 'image/png', data: this.state.data },
        
        { name: 'pdf', filename: 'image.png', type: 'application/pdf', data: this.state.pdf },
  ...
  uploadPdfToServer = () => {
    ...
    RNFetchBlob.fetch('POST', 'http://alaziziyamanpower.com/new_webservices/model/upload_image.php', {
      ...
      'Content-Type': 'multipart/form-data',
        ...
        { name: 'image', filename: 'image.png', type: 'application/pdf', data: this.state.pdf },
    ...
    if(url){
      console.log(url, 'sss')
        ...
        var output = url.uri+'/'+url.fileName;
            ...
            RNFetchBlob.fs.readFile(url.uri || '', 'base64')
            .then((imageDataBase64) => {
  ...
  finish(){
    ...
    if(this.state.half_image != "" &&
       ...
       //this.state.cv_image != ""
        ...
        // fetch('http://alaziziyamanpower.com/new_webservices/register.php?'+params, {
      ...
      //       index: 0,
      //       actions: [NavigationActions.navigate({ routeName: routes.tabbarNav})],
      //     });
      //     this.props.navigation.dispatch(resetAction);
      //       console.log('Register - Response', JSON.stringify(responseJson.data) )
  ...
  render(){
    ...
    >
        ...
        <Text style = {{fontSize:14, color:'white', marginLeft:32, marginTop:16}}>Upload half image</Text>
       
        
        <View style = {{flexDirection:'row'}}>
        <Ripple 
           onPress={()=>this.selectPhoto2(1)}
          style = {{backgroundColor:'#8D1B3D',  height:30, width:150, alignSelf:'flex-start', borderRadius:10, marginLeft:36, marginTop:16, marginBottom:16, flexDirection:'row'}}>
        <MaterialIcons.Button
                  ...
                  />
                          ...
                          style = {{fontSize:16, color:'white', marginLeft:0, marginTop:0, justifyContent:'center', alignSelf:'center'}}>Choose files</Text>
        ...
        <Text style = {{fontSize:14, color:'white', marginLeft:32, marginTop:16}}>Upload full image</Text>
        ...
        <MaterialIcons.Button
                  ...
                  />
                          <Text style = {{fontSize:16, color:'white', marginLeft:0, marginTop:0, justifyContent:'center', alignSelf:'center'}}>Choose file</Text>
        ...
        <Text style = {{fontSize:14, color:'white', marginLeft:32, marginTop:16}}>Upload CV</Text>
       ...
       <View style = {{flexDirection:'row', flex:1,}}>
        ...
        <Ripple 
          ...
          style = {{backgroundColor:'#8D1B3D', height:50, width:Global.screenWidth, position:'absolute', bottom:0, alignSelf:'center', justifyContent:'center'}}>
