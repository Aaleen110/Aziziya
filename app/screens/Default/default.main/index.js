...
import {Image, Text, View, ScrollView, Alert, FlatList, Modal, Linking, BackHandler, RefreshControl, ImageBackground } from 'react-native';
    ...
    // fetch('http://alaziziyamanpower.com/new_webservices/getProfileAll.php', {
		...
		fetch('http://alaziziyamanpower.com/new_webservices/list-all-resume.php?', {
			...
			if (responseJson.message == 800){
				...
				console.log('get All resume default - Response', JSON.stringify(responseJson.data) )
