    ...
    fetch(URLs.URLs.allResume, {
      ...
      .then(responseJson => {
        if (responseJson.message == 800) {
          ...
          console.log(
            "get All resume default - Response",
    ...
    return (
      ...
      >
        ...
        >
          <Ripple
            onPress={() => {
              console.log("Aaa", this.state.currentData);
          ...
          <View style={{ marginTop: 16 }}>
            ...
            >
              ...
              <FontAwesome5.Button
                ...
                color={"#611e32"}
                onPress={() => {
                  Linking.openURL(`whatsapp://send?text=&phone=${97433263555}`);
                }}
                underlayColor="transparent"
                backgroundColor="transparent"
              />
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {this.state.language == 0 ? "Arabic" : "English"}
          </Text>
        </View>
