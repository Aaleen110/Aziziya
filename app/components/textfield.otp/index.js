...
export default class TextFieldOTP extends Component {
  ...
  getNumberSection (alphabet, key) {
    return <TextInput ref={key} key={key} style={[styles.textLableOTP, {width: Global.screenWidth / 10, height : Global.iOSPlatform ? 50 : 75,fontSize: this.state.size}]} value={alphabet} underlineColorAndroid='transparent' placeholderTextColor='white' onFocus={(() => this.getFocus()).bind(this)} keyboardType='numeric' selectionColor='transparent'
    />
  }
